...
func start_movement_timer():
	...
	if tiles[current_row][current_col].tile_type != TileType.START:
...
func npc_choose_move():
	...
	selected_npc_tile.set_selected("npc1")
...
func npc2_choose_move():
	...
	selected_npc2_tile.set_selected("npc1")
